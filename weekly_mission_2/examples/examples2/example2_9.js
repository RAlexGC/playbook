...
class Developer {
  ...
  const alexLaunchXDev = new LaunchXStudent("Alejandro", "js", ["python", "html", "css"])
  console.log(alexLaunchXDev)
  console.log(alexLaunchXDev.getName) // getter de la clase padre rehusada en la clase hija